...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.tsm.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TsmPackage.Literals.STATE_MACHINE__START,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TsmPackage.Literals.STATE_MACHINE__STATES);
			childrenFeatures.add(TsmPackage.Literals.STATE_MACHINE__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TsmPackage.Literals.STATE_MACHINE__STATES,
				 TsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(TsmPackage.Literals.STATE_MACHINE__TRANSITIONS,
				 TsmFactory.eINSTANCE.createTransition()));
	}
