...
import at.ac.tuwien.big.tsm.util.TsmValidator;
 ...
 * @generated
 */
public class TsmPackageImpl extends EPackageImpl implements TsmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see at.ac.tuwien.big.tsm.TsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TsmPackageImpl() {
		super(eNS_URI, TsmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TsmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TsmPackage init() {
		if (isInited) return (TsmPackage)EPackage.Registry.INSTANCE.getEPackage(TsmPackage.eNS_URI);

		// Obtain or create and register package
		TsmPackageImpl theTsmPackage = (TsmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TsmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TsmPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theTsmPackage.createPackageContents();

		// Initialize created meta-data
		theTsmPackage.initializePackageContents();
			...
			(theTsmPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return TsmValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theTsmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TsmPackage.eNS_URI, theTsmPackage);
		return theTsmPackage;
	}
	 ...
	 * @generated
	 */
	public TsmFactory getTsmFactory() {
		return (TsmFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getTransition_Timer(), this.getTimeEvent(), null, "timer", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (stateMachineEClass, 
		   source, 
		   new String[] {
			 "constraints", "StateNamesStartWithLowerCaseLetter"
		   });	
		addAnnotation
		  (stateEClass, 
		   source, 
		   new String[] {
			 "constraints", "OneOutgoingEdge"
		   });	
		addAnnotation
		  (timeEventEClass, 
		   source, 
		   new String[] {
			 "constraints", "TimeGreaterZero"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (stateMachineEClass, 
		   source, 
		   new String[] {
			 "StateNamesStartWithLowerCaseLetter", "self.states -> forAll(s : State | s.name.at(1) = s.name.at(1).toLowerCase())"
		   });	
		addAnnotation
		  (stateEClass, 
		   source, 
		   new String[] {
			 "OneOutgoingEdge", "self.outgoing -> size() = 1"
		   });	
		addAnnotation
		  (timeEventEClass, 
		   source, 
		   new String[] {
			 "TimeGreaterZero", "self.time > 0"
		   });
	}
